package com.example.empresaclientes.VentasUser;
...
public class ListaDeLaCompraUser extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lista_de_la_compra_user);
        ...
        ArrayAdapter<Item> adapter = new ArrayAdapter<Item>(this, R.layout.item_lista_de_la_compra, R.id.textViewNombreProducto, selectedItems) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (item != null) {
                    ...
                    Glide.with(ListaDeLaCompraUser.this)
                            .load(item.getFoto())
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListaDeLaCompraUser.this, ListViewActivityVentasUser.class);
        ...
        btnFinalizarCompra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ListaDeLaCompraUser.this, "Purchased succesfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ListaDeLaCompraUser.this, SeleccionImagenUser.class);
                startActivity(intent);
            }
        });
    }}