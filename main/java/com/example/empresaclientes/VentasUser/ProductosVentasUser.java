...
import com.example.empresaclientes.VentasAdmin.MyAdapterVentas;


import java.util.ArrayList;
import java.util.List;

public class ProductosVentasUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProductosVentasUser.this, ListViewActivityVentasUser.class);
        ...
        imageListaDeLaCompra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProductosVentasUser.this, ListaDeLaCompraUser.class);
