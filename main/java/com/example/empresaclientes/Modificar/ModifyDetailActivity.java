...
public class ModifyDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_modify);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ModifyDetailActivity.this, ListViewActivityModify.class);
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkdeletedata) {
                    Toast.makeText(ModifyDetailActivity.this, "Client Deleted", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ModifyDetailActivity.this, ListViewActivityModify.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(ModifyDetailActivity.this, "Client Not Deleted", Toast.LENGTH_SHORT).show();
                }
        ...
        btnModificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ModifyDetailActivity.this, ModificarCliente.class);
